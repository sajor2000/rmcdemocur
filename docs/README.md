...
| [009 — Curriculum image ingestion](plans/2026-07-03-009-feat-curriculum-image-ingestion-plan.md) | Partial | Faculty DOCX extract, map previews done (MVP); self-study/PDF/vision OCR (U8–U10) still deferred |
...
| [2026-07-04-002 — Surface keyword/figure data](plans/2026-07-04-002-feat-surface-keyword-figure-data-plan.md) | Partial | Keyword chips + definitions shipped (PR #10); figure_captions and keyword filter still deferred |
...
| [2026-07-05-003 — Demo-readiness coverage/visual audit](plans/2026-07-05-003-fix-demo-readiness-coverage-visual-audit-plan.md) | Partial | PR #27 distinguishes the two coverage methodologies; `gap_summary` retirement and a committed visual-regression baseline still not done |
